...
d2 = Image.open('./drumset_images/d2.png').convert('RGBA')
d2 = d2.resize((250,300), Image.ANTIALIAS)

d3 = Image.open('./drumset_images/image.png').convert('RGBA')
d3 = d3.resize((230,330), Image.ANTIALIAS)

d4 = Image.open('./drumset_images/drum.png').convert('RGBA')
d4 = d4.resize((260,400), Image.ANTIALIAS)


d = Image.open('drumset_images/d1.png').convert('RGBA')
...
bass=pygame.mixer.Sound('music_samples/BassDrums1/bassdrum3.wav')
